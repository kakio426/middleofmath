...
- 발행된 2.1.0은 UPDATE·DELETE 트리거로 고칠 수 없으므로 수정은 2.2.0 신규 발행으로만 반영된다(`202608070001`). 2.1.0 마이그레이션은 grade4-semester1 1.3.0과 같은 방식으로 SHA-256 핀을 걸어 바이트 그대로 보존한다. 2.2.0 DB checksum은 `0a07f0c6…e8422`.
